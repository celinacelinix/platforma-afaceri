...
const ETICHETA_CFG: Record<string, { label: string; bg: string; color: string; barColor: string }> = {
      ...
      <div style={lay.body}>
        ...
        <main style={lay.content}>
          {activeChapter === 7 ? (
            ...
            <div style={ch7.wrap}>
              <Capitol nr={6} title="Autorizații" fields={[]} state={{ ...buildState(...params_op), concept, localitate, tip_afacere: tipAfacere }} rez={rez} onAssemble={() => "Sistemul a generat automat lista de autorizații necesare din configurație."} isAutoGenerated onCompletionChange={(val) => handleCompletionChange(6, val)} />
            </div>
          ) : activeChapter === 8 ? (
            <div style={ch7.wrap}>
